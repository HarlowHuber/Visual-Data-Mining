...
// this class is used to keep track of each bit vector ...
// put here because used both by the input and the nvboolfunc



#define BOOLEAN_DEF
typedef int Boolean; // yes I know I should rewrite the HanselChain program
...
protected:
	bool* bit_array;					// array containing the bits
